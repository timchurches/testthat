...
*   checking package subdirectories ... WARNING
    ```
    ...
      inst/NEWS.Rd:44: unexpected section header '\section'
      inst/NEWS.Rd:55: unexpected section header '\section'
      inst/NEWS.Rd:64: unexpected section header '\section'
      inst/NEWS.Rd:72: unexpected section header '\section'
      inst/NEWS.Rd:81: unexpected section header '\section'
      inst/NEWS.Rd:96: unexpected section header '\section'
      inst/NEWS.Rd:106: unexpected section header '\section'
      inst/NEWS.Rd:119: unexpected section header '\section'
      inst/NEWS.Rd:147: unexpected section header '\section'
      inst/NEWS.Rd:157: unexpected section header '\section'
      inst/NEWS.Rd:165: unexpected section header '\section'
      inst/NEWS.Rd:197: unexpected section header '\section'
      inst/NEWS.Rd:205: unexpected section header '\section'
      inst/NEWS.Rd:231: unexpected section header '\section'
      inst/NEWS.Rd:239: unexpected section header '\section'
      inst/NEWS.Rd:248: unexpected section header '\section'
      inst/NEWS.Rd:257: unexpected section header '\section'
      inst/NEWS.Rd:267: unexpected section header '\section'
      inst/NEWS.Rd:289: unexpected section header '\section'
      inst/NEWS.Rd:300: unexpected END_OF_INPUT '
      '
    ```
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      1. Error: Package Style (@test-lintr.R#5) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      Error in eval(exprs[i], envir) : 
        1 error out of 5939 (lastID=1751, endian==little, sizeof(long double)==16, sizeof(pointer)==8) in inst/tests/tests.Rraw on Sat Sep 16 10:00:16 2017. Search tests.Rraw for test number 1751.
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      4: importNGWMN(url, asDateTime, tz = "")
      5: stop("Unrecognized response from the web service")
      
      2. Failure: Unit value data returns correct types (@tests_userFriendly_fxns.R#38) 
      all(...) isn't true.
      
      
      Read 7 items
      testthat results ================================================================
      OK: 166 SKIPPED: 0 FAILED: 2
      1. Error: NGWMN functions working (@tests_general.R#262) 
      2. Failure: Unit value data returns correct types (@tests_userFriendly_fxns.R#38) 
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
             date_max = "2012-05-01", test_name = "CHLOROPHYLLA-SALINE")), 3) at testthat/test-getwq.R:56
      2: compare(object, expected, ...)
      3: ncol(get_wq(station_id = c("FLAB08", "FLAB09"), date_min = "2011-03-01", date_max = "2012-05-01", 
             test_name = "CHLOROPHYLLA-SALINE"))
      4: get_wq(station_id = c("FLAB08", "FLAB09"), date_min = "2011-03-01", date_max = "2012-05-01", 
             test_name = "CHLOROPHYLLA-SALINE")
...
*   checking re-building of vignette outputs ... WARNING
    ...
    Quitting from lines 378-380 (derfinderPlot.Rmd) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      4. Failure: python.test.g: python.test.g.1 (@test-dparser.R#96) ----------------
      `test` not equal to `ref`.
      Lengths differ: 2 vs 50
      
      
      testthat results ================================================================
      OK: 678 SKIPPED: 0 FAILED: 4
      1. Failure: g25.test.g: g25.test.g.1 (@test-dparser.R#96) 
      2. Failure: g47.test.g: g47.test.g.1 (@test-dparser.R#96) 
      3. Failure: g49.test.g: g49.test.g.1 (@test-dparser.R#96) 
      4. Failure: python.test.g: python.test.g.1 (@test-dparser.R#96) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      1: expect_equal(12, nrow(x5), length(unique(x5$target)), length(unique(x5$command))) at testthat/test-generate.R:53
      2: compare(object, expected, ...)
      3: compare.numeric(object, expected, ...)
      4: all.equal(x, y, tolerance = tolerance, check.attributes = check.attributes, ...)
      5: all.equal.numeric(x, y, tolerance = tolerance, check.attributes = check.attributes, 
      ...
      testthat results ================================================================
      OK: 363 SKIPPED: 2 FAILED: 1
      1. Error: evaluate, expand, and gather (@test-generate.R#53) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      testthat results ================================================================
      OK: 1906 SKIPPED: 4 FAILED: 13
      1. Error: Errors in centroid argument are correctly detected by dtwclust. 
      2. Error: Errors in centroid argument are correctly detected by tsclust. 
      3. Error: Pairwise proxy distances give the same result as references 
      4. Error: Included (valid) distances can accept multivariate series. 
      5. Error: Pairwise proxy distances give the same result as references 
      6. Error: Distance matrices calculated with families give the same results as references. 
      7. Error: Centroids calculated with families give the same results as references. 
      8. Error: A custom distance in dtwclust give the same results as references. 
      9. Error: CVIs give the same results as references. 
      1. ...
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      1. Error: source lints (@test_lint.R#7) 
...
*   checking package dependencies ... NOTE
    ```
    Packages suggested but not available for checking: ‘openCyto’ ‘ggcyto’
    ```
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      6. Error: Code Lint (@test_lint.R#27) 
...
***********************************************
** libs
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c platform.cpp -o platform.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c utils-vcl.cpp -o utils-vcl.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c device.cpp -o device.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c context.cpp -o context.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c gpuMatrix_igemm.cpp -o gpuMatrix_igemm.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c RcppExports.cpp -o RcppExports.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c trunc_gpuMat.cpp -o trunc_gpuMat.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c utils.cpp -o utils.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c chol.cpp -o chol.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c set_row_order.cpp -o set_row_order.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c gpuEigenPtr.cpp -o gpuEigenPtr.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c vclPtr.cpp -o vclPtr.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c solve.cpp -o solve.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c vienna_svd.cpp -o vienna_svd.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c vienna_blas1.cpp -o vienna_blas1.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c vienna_blas3.cpp -o vienna_blas3.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c vienna_eigen.cpp -o vienna_eigen.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c vienna_qr.cpp -o vienna_qr.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -I../inst/include -DCL_HPP_MINIMUM_OPENCL_VERSION=110 -DCL_USE_DEPRECATED_OPENCL_1_2_APIS -DCL_HPP_TARGET_OPENCL_VERSION=120 -I'/usr/include/' -DHAVE_CL_CL2_HPP -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RcppEigen/include" -I"/home/muelleki/git/R/testthat/revdep/library/gpuR/RViennaCL/include" -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/BH/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c vienna_stats.cpp -o vienna_stats.o
...
*   checking package dependencies ... NOTE
    ```
    Package suggested but not available for checking: ‘egg’
    ```
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
             1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 
             2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 
             2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 
             2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 
             2L, 2L, 2L, 2L, 2L, 2L, 2L), .Label = c("0", "1"), class = "factor"))
...
*   checking Rd \usage sections ... NOTE
    ```
    S3 methods shown with full name in documentation object 'bind':
      ‘cbind.hyperSpec’ ‘rbind.hyperSpec’
...
*   checking tests ...
    ...
    Running the tests in ‘tests/test-all.R’ failed.
    Last 13 lines of output:
      1: jaod_journal_search(query = "publisher:dove", pageSize = 2) at testthat/test-jaod_journal_search.R:25
      2: jaod_parse(jGET(file.path(doaj_base(), "search", "journals", query), query = jc(list(page = page, 
      ...
      1. Error: jaod_journal_search - params work (@test-jaod_journal_search.R#25) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      testthat results ================================================================
      OK: 438 SKIPPED: 9 FAILED: 1
      1. Error: Package Style (@test-lint.R#5) 
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      3. Error: We create unique keys when necessary (@test_cite.R#47) ---------------
      argument is of length zero
      1: bibliography() at testthat/test_cite.R:47
      2: sapply(sort(bibs), csl_formatting)
      3: lapply(X = X, FUN = FUN, ...)
      4: FUN(X[[i]], ...)
      
      testthat results ================================================================
      OK: 6 SKIPPED: 0 FAILED: 3
      1. Error: we can cite by doi (@test_cite.R#9) 
      2. Error: We can cite by R package / bibentry (@test_cite.R#33) 
      3. Error: We create unique keys when necessary (@test_cite.R#47) 
...
*   checking re-building of vignette outputs ... WARNING
    ...
    Warning in engine$weave(file, quiet = quiet, encoding = enc) :
      The vignette engine knitr::rmarkdown is not available, because the rmarkdown package is not installed. Please install it.
    Server error [504] for doi "10.1098/rspb.2013.1372", you may want to try again, or BibTeX unavailable for this doi
    no results with relavency score greater than 'min.relevance' successfully retrieved
    Quitting from lines 63-78 (tutorial.Rmd) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      b["user.self"]/b["elapsed"] is not strictly more than 1.5. Difference: -0.461
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      3: compare.default(object, expected, ..., check.attributes = FALSE)
      4: all.equal(x, y, ...)
...
*   checking package dependencies ... NOTE
    ```
    Packages suggested but not available for checking: ‘RLumShiny’ ‘RLumModel’
    ```

*   checking Rd cross-references ... NOTE
    ```
    Packages unavailable to check Rd xrefs: ‘RLumShiny’, ‘RLumModel’
    ```
...
*   checking examples ... ERROR
    ...
    /home/muelleki/tmp/Rtmp9kuaru/file237449b57c94.sqlite3
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      testthat results ================================================================
      OK: 62 SKIPPED: 0 FAILED: 1
      1. Error: Package Style (@test-lintr.R#3) 
...
** libs
g++  -I/usr/share/R/include -DNDEBUG  -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c mwaved.cpp -o mwaved.o
...
g++  -I/usr/share/R/include -DNDEBUG  -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c RcppExports.cpp -o RcppExports.o
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      2. Failure: Test HS023. (@test-hs023.R#95) -------------------------------------
      all(eval_g_ineq(res$solution)$constr <= res$options$tol_constraints_ineq) isn't true.
      
      
      testthat results ================================================================
      OK: 41 SKIPPED: 0 FAILED: 2
      1. Failure: Test HS023. (@test-hs023.R#90) 
      2. Failure: Test HS023. (@test-hs023.R#95) 
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      1: expect_equivalent(round(fit.TB.RE.INLA$nu[1], 2), -0.76) at testthat/test_first.R:30
      2: compare(object, expected, ..., check.attributes = FALSE)
...
** libs
gcc -std=gnu99 -I/usr/share/R/include -DNDEBUG -fopenmp -D_GLIBCXX_USE_C99 -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c normr_init.c -o normr_init.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -fopenmp -D_GLIBCXX_USE_C99 -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c RcppExports.cpp -o RcppExports.o
g++ -std=gnu++11 -I/usr/share/R/include -DNDEBUG -fopenmp -D_GLIBCXX_USE_C99 -I"/home/muelleki/git/R/testthat/revdep/library/testthat/new/Rcpp/include"    -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g -c em.cpp -o em.o
...
gcc: error: keygen.o: No such file or directory
...
gcc -std=gnu99 -I/usr/share/R/include -DNDEBUG      -fpic  -g -O2 -fstack-protector-strong -Wformat -Werror=format-security -Wdate-time -D_FORTIFY_SOURCE=2 -g  -c ssl.c -o ssl.o
gcc -std=gnu99 -shared -L/usr/lib/R/lib -Wl,-Bsymbolic-functions -Wl,-z,relro -o openssl.so aes.o base64.o bignum.o cert.o compatibility.o diffie.o envelope.o error.o hash.o info.o keygen.o keys.o onload.o openssh.o password.o pem.o pkcs12.o pkcs7.o rand.o rsa.o signing.o ssl.o stream.o write.o -l:libssl.so.1.0.0 -l:libcrypto.so.1.0.0 -L/usr/lib/R/lib -lR
installing to /home/muelleki/git/R/testthat/revdep/checks/openssl/old/openssl.Rcheck/openssl/libs
** R
** inst
** preparing package for lazy loading
** help
...
*   checking tests ...
    ...
    Last 13 lines of output:
             ...
             e$handled <- TRUE
             test_error <<- e
         }, "could not find function \"glmnet.cr\"", quote(glmnet.cr(x, y, lambda = 0, method = "forward"))) at testthat/test-ordinalNet.R:187
      2: eval(code, test_env)
      
      testthat results ================================================================
      OK: 44 SKIPPED: 0 FAILED: 1
      1. Error: Elastic net sratio matches glmnetcr::glmnet.cr (@test-ordinalNet.R#187) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      testthat results ================================================================
      OK: 55 SKIPPED: 2 FAILED: 1
      1. Error: p_install works (@test-p_install.R#7) 
...
*   checking examples ... ERROR
    ```
    Running examples in ‘prioritylasso-Ex.R’ failed
    The error most likely occurred in:
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      6: predict.lognet(fitobj, x[which, , drop = FALSE], s = lambda[which_lam], offset = off_sub, 
             type = "response")
      7: NextMethod("predict")
      8: predict.glmnet(fitobj, x[which, , drop = FALSE], s = lambda[which_lam], offset = off_sub, 
             type = "response")
      9: stop("No newoffset provided for prediction, yet offset used in fit of glmnet", call. = FALSE)
      
      testthat results ================================================================
      OK: 0 SKIPPED: 0 FAILED: 3
      1. Error: (unknown) (@test-cvmpl.R#2) 
      2. Error: (unknown) (@test-pl.R#2) 
      3. Error: (unknown) (@test-predict.R#2) 
...
*   checking re-building of vignette outputs ... WARNING
    ...
    Error in re-building vignettes:
      ...
    Quitting from lines 47-50 (prioritylasso_vignette.Rmd) 
    Error: processing vignette 'prioritylasso_vignette.Rmd' failed with diagnostics:
...
*   checking tests ...
    ...
    Last 13 lines of output:
      unused argument (height)
      1: plotStructures("94600", drugAnnot["94600", "SMILES"]) at /home/muelleki/git/R/testthat/revdep/checks/rcellminer/new/rcellminer.Rcheck/rcellminer/tests/test_plotStructures.R:6
...
*   checking tests ...
    ...
    Last 13 lines of output:
      testthat results ================================================================
      OK: 82 SKIPPED: 0 FAILED: 31
      1. Error: cr_ageny returns correct class (@test_cr_agency.R#7) 
      2. Error: cr_cn returns (@test_cr_cn.R#6) 
      3. Error: DOIs with no agency found still work, at least some do (@test_cr_cn.R#38) 
      4. Failure: cr_cn checks if doi agency supports format (@test_cr_cn.R#53) 
      5. Error: cr_funders returns (@test_cr_funders.R#7) 
      6. Error: cr_funders facet works (@test_cr_funders.R#29) 
      7. Error: cr_journals metadata works correctly (@test_cr_journals.R#21) 
      8. Error: cr_journals facet works (@test_cr_journals.R#33) 
      9. Error: cr_journals warns correctly (@test_cr_journals.R#50) 
      1. ...
...
*   checking examples ... ERROR
    ...
    + }
    2017-09-16 20:56:02 loadCoverage: loading BigWig file http://duffel.rail.bio/recount/DRP002835/bw/mean_DRP002835.bw
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      2: In .Internal(gc(verbose, reset)) :
        closing unused connection 3 (/home/muelleki/tmp/RtmpWoUnev/GSM1062236.soft)
      Execution halted
    ```
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      1. Failure: Write Batch -Insert (@test-write-batch.R#52) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      4. Error: returns the correct class (@test-occ_get.r#6) 
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      Content type 'text/html; charset=utf-8' length 481941 bytes (470 KB)
      ==================================================
      downloaded 470 KB
...
*   checking re-building of vignette outputs ... WARNING
    ...
    Quitting from lines 106-113 (intro.Rmd) 
    Error: processing vignette 'intro.Rmd' failed with diagnostics:
...
*   checking tests ...
    ...
    Running the tests in ‘tests/testthat.R’ failed.
    Last 13 lines of output:
      Testing term SO:0001424 
      Testing term SO:0001701 
      Testing term SO:0000239 
      Testing term SO:0000933 
      Testing term SO:0001982 
      Testing term SO:0002074 
      Testing term SO:0001212 
      Testing term SO:0001453 
      Testing term SO:0000971 
      testthat results ================================================================
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ==================================================
      2. Failure: PXD version (@test_px.R#44) ----------------------------------------
      p@formatVersion not identical to "1.2.0".
      1/1 mismatches
      x[1]: "1.3.0"
      y[1]: "1.2.0"
      ...
      1. Failure: PXD000001 (@test_px.R#26) 
      2. Failure: PXD version (@test_px.R#44) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      3. Error: allphenotypes returns the correct class (@test-allphenotypes.R#7) 
      4. Error: allphenotypes returns the correct dims for data.frame (@test-allphenotypes.R#13) 
      5. Error: allphenotypes returns the correct value (@test-allphenotypes.R#19) 
      6. Error: annotations returns the correct class (@test-annotations.R#7) 
      7. Error: genotypes returns the correct class (@test-genotypes.R#6) 
      8. Error: phenotypes returns the correct class (@test-phenotypes.R#7) 
      9. Error: phenotypes_byid returns the correct class (@test-phenotypes_byid.R#7) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      2. Error: (unknown) (@test-api_example_tests.R#2) 
      3. Error: (unknown) (@test-cookie_tests.R#2) 
      4. Error: (unknown) (@test-executing_javascript_tests.R#2) 
      5. Error: (unknown) (@test-frame_switching_tests.R#2) 
      6. Error: (unknown) (@test-page_loading_tests.R#2) 
      7. Error: (unknown) (@test-takes_screenshots_tests.R#2) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      2: compare(object, expected, ...)
      3: timeIntegration(c(1, 3), c("07-May-2009 15:00", "07-May-2009 16:00"))
      4: formatDT(time)
      5: stop("The first non-missing date ", date.string, " is incorrect or has an invalid format.\n")
...
A specific python version to use was not provided, defaulting to the standard Python in the system.
Unable to locate python-config - please ensure SNAKECHARMR_PYTHON_VERSION environment variable is set correctly.
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      4: spacy_initialize()
      5: stop("spaCy or language model ", model, " is not installed in any of python executables.")
...
*   checking re-building of vignette outputs ... WARNING
    ...
    Default paths for SpaDES directories set to:
      cachePath:  /home/muelleki/tmp/RtmpI7pkO7/SpaDES/cache
      inputPath:  /home/muelleki/tmp/RtmpI7pkO7/SpaDES/inputs
      modulePath: /home/muelleki/tmp/RtmpI7pkO7/SpaDES/modules
      outputPath: /home/muelleki/tmp/RtmpI7pkO7/SpaDES/outputs
...
*   checking tests ...
    ...
    Last 13 lines of output:
      > 
      > test_check("taxa")
      1. Error: Taxmap can be intialized from queried data (@test--taxmap_parsers.R#127) 
      'names' attribute [1] must be the same length as the vector [0]
      1: lookup_tax_data(raw_data, type = "seq_id", datasets = list(counts = abundance, my_names = common_names, 
             foods = foods), mappings = c(species_id = "id", species_id = "{{name}}", `{{index}}` = "{{index}}"), 
             column = "my_seq") at testthat/test--taxmap_parsers.R:127
      2: stats::setNames(data.frame(class_strings, stringsAsFactors = FALSE), internal_class_name)
      
      testthat results ================================================================
      OK: 414 SKIPPED: 1 FAILED: 1
      1. Error: Taxmap can be intialized from queried data (@test--taxmap_parsers.R#127) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      5. Failure: genbank2uid - with accession numbers (@test-genbank2uid.R#18) 
      6. Failure: genbank2uid - with accession numbers (@test-genbank2uid.R#22) 
      7. Error: genbank2uid - with accession numbers (@test-genbank2uid.R#23) 
      8. Error: iucn_id returns the correct class (@test-iucn_id.R#7) 
      9. Error: iucn_id fails well (@test-iucn_id.R#24) 
      1. ...
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      2. Error: search treebase works as expected (@test_treebase.R#5) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      1. Error: Package Style (@test-pkg-style.R#5) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      3. Error: (unknown) (@testthat.error.R#3) 
      4. Error: (unknown) (@testthat.exec.R#11) 
      5. Error: (unknown) (@testthat.inpkg.R#11) 
      6. Error: (unknown) (@testthat.item.R#4) 
      7. Error: diff conditionList (@testthat.misc.R#382) 
      8. Error: (unknown) (@testthat.parse.R#5) 
      9. Failure: simple tests (@testthat.section.R#13) 
      1. ...
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      2. Error: Package Style (@test-pkg-style.R#5) 
...
*   checking tests ...
    ...
    Last 13 lines of output:
      ...
      testthat results ================================================================
      OK: 132 SKIPPED: 0 FAILED: 6
      1. Error: visualization in general works (@test-automat.R#137) 
      2. Failure: visualization of empty automat works (@test-automat.R#145) 
      3. Error: visualization without set state works (@test-automat.R#153) 
      4. Error: visualization with implicit state works (@test-automat.R#162) 
      5. Error: visualization works (@test-automat.R#176) 
      6. Error: edge_present_lab helper works (@test-automat.R#209) 
...
*   checking re-building of vignette outputs ... WARNING
    ...
    Error in re-building vignettes:
      ...
    Quitting from lines 53-54 (Automat.Rmd) 
    Error: processing vignette 'Automat.Rmd' failed with diagnostics:
...
*   checking tests ...
    ...
    Last 13 lines of output:
      2: compare(object, expected, ..., check.attributes = FALSE)
      3: compare.numeric(object, expected, ..., check.attributes = FALSE)
      4: all.equal(x, y, tolerance = tolerance, check.attributes = check.attributes, ...)
      5: all.equal.numeric(x, y, tolerance = tolerance, check.attributes = check.attributes, 
             ...)
    ...
    Last 13 lines of output:
      ...
      * DONE (maxlike)
      ...
      The downloaded source packages are in
      	'/home/muelleki/tmp/RtmpN1SqAd/downloaded_packages'
      testthat results ================================================================
